...
import com.edu.project.entities.Reponse;
...
import com.edu.project.service.ReponseService;
...
public class Detailswindow2Controller implements Initializable {
    ...
    @FXML
    private void savereponse(ActionEvent event) throws MessagingException {
