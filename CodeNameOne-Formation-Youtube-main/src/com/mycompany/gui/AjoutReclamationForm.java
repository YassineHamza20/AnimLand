...
public class AjoutReclamationForm extends BaseForm {
    ...
    public AjoutReclamationForm(Resources res) {
        ...
        RadioButton mesListes = RadioButton.createToggle("liste des Produits", barGroup);
...
//        bindButtonSelection(liste, arrow);
        ...
        //
         TextField nom = new TextField("", "Tapez Nom");
    nom.setUIID("TextFieldBlack");
    addStringValue("Nom", nom);

    TextField prix = new TextField("", "Tapez Prix");
...
float floatValue = Float.parseFloat(prix.getText());
System.out.println("prix = " + floatValue);

if (nomValue == null || nomValue.isEmpty()) {
    Dialog.show("Error", "Nom cannot be empty", "OK", null);
    iDialog.dispose();
    return;
}
