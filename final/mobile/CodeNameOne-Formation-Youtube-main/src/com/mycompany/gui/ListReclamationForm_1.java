 ...
 * @author Lenovo
 */
public class ListReclamationForm_1 extends BaseForm{
    
    Form current;
    public ListReclamationForm_1(Resources res ) {
          super("Newsfeed",BoxLayout.y()); //herigate men Newsfeed w l formulaire vertical
        Toolbar tb = new Toolbar(true);
        current = this ;
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("Listed des Produits ");
...
//        liste.setUIID("SelectBar");
        ...
        final Dialog ipDlg = ip.showInifiniteBlocking();
         ...
         ListReclamationForm_1 a = new ListReclamationForm_1(res);
            a.show();
            refreshTheme();
        });
...
//        bindButtonSelection(liste, arrow);
        ...
        ArrayList<Object>list = ServiceProduit.getInstance().produit();
        ...
        for(Object rec : list ) {
             ...
             URLImage urlim = URLImage.createToStorage(enc, urlImage, urlImage, URLImage.RESIZE_SCALE);
                ...
                addButton(urlim, (Produit) rec,res);
    ...
    private void updateArrowPosition(Button btn, Label l) {
     ...
     private void addButton(Image img,Produit rec , Resources res) {
      ...
      Label IDTxt = new Label("id : " + rec.getId(), "NewsTopLine2");
    ...
    Label prixTxt = new Label("Prix : " + rec.getPrix(), "NewsTopLine2");
        ...
        if(rec.getId() == 0 ) {
            IDTxt.setText("non Traitée");
        }
        else 
            IDTxt.setText("Traitée");
    ...
    deleteButton.addActionListener(e -> {
        if (ServiceProduit.getInstance().deleteReclamation(rec.getId())) {
            new ListReclamationForm_1(res).show();
        ...
        lSupprimer.setTextPosition(RIGHT);
          ...
          cnt.add(BorderLayout.EAST, deleteButton);
        //click delete icon
...
Label lModifier = new Label(" ");
        ...
        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(
                ...
                BoxLayout.encloseX(NomTxt),
                           BoxLayout.encloseX(prixTxt,lModifier)));
...
//    Button image = new Button(img.fill(width, height));
//    image.setUIID("Label");
//    Container imageCnt = BorderLayout.west(image);
//
//    Label IDTxt = new Label("id : " + rec.getId(), "NewsTopLine2");
//    Label NomTxt = new Label("Nom : " + rec.getNom(), "NewsTopLine2");
//    Label prixTxt = new Label("Prix : " + rec.getPrix(), "NewsTopLine2");
//
//
////    Container labelsCnt = BoxLayout.encloseY(
////        BoxLayout.encloseX(NomTxt),
...
//        }
//    });
//    Container deleteCnt = BoxLayout.encloseY(deleteButton);
//
//    // add components to main container
//    Container mainCnt = BorderLayout.center(deleteCnt);
////    mainCnt.add(BorderLayout.WEST, deleteCnt);
//
//    Container cnt = BorderLayout.center(imageCnt);
////    cnt.add(BorderLayout.CENTER, mainCnt);
//
////    add(cnt);
//    
//        //click delete icon
//        deleteCnt.addPointerPressedListener(l -> {
//            
//            Dialog dig = new Dialog("Suppression");
//            
//            if(dig.show("Suppression","Vous voulez supprimer ce reclamation ?","Annuler","Oui")) {
