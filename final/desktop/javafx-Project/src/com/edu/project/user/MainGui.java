...
import pidev.usermain;

import com.edu.project.service.CategoryController;
import com.edu.project.service.ServiceController;
...
public class MainGui {
    ...
    @FXML private TableColumn<Service, Integer> likes;
    ...
    @FXML private void openAddCategory(ActionEvent event){
        
        try {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("FXMLADDCategory.fxml"));
    ...
    likes.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<Service, Integer>, ObservableValue<Integer>>() {
        @Override
        public ObservableValue<Integer> call(TableColumn.CellDataFeatures<Service, Integer> param) {
            return new SimpleIntegerProperty(param.getValue().getLikes()).asObject();
        }
    });
    ...
    @FXML private void showServiceWhenSelected(ActionEvent event) {
        ...
        Service updatedService =new Service(idCaptured.getId(),idCaptured.getPrix(),idCaptured.getNom(),idCaptured.getDescription(),idCaptured.getDate(),idCaptured.getCategory(),idCaptured.getViewCount()+1,idCaptured.getLikes());
    ...
    @FXML private void openServiceWindow(ActionEvent event)  {
       
     
        
          try {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("FXMLADDService.fxml"));
        Parent root = loader.load();
        Scene scene = new Scene(root);
        Stage stage = new Stage();
        stage.setScene(scene);
    ...
    @FXML private void exportPdf(ActionEvent event) throws IOException, AWTException {
        ...
        double totalPrice;
            ...
            String text = "Hello " + nom + "! " +
                    "Votre Service " + description + " est disponible " +
                    "il cout " + prix + " et commence le " + date ;
    ...
    @FXML private void onRating(ActionEvent event)   {

        
         try {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("addRating.fxml"));
        Parent root = loader.load();
        Scene scene = new Scene(root);
        Stage stage = new Stage();
        stage.setScene(scene);
...
//        servicesTableView.refresh();
//        servicesTableView.getSelectionModel().select(idCaptured);
//        new SERVICES().showNotif("You DisLiked This service", "Service has been DisLiked");
//    }
    }
