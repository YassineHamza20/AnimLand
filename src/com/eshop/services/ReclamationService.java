...
//                                          +"&stock_p="+t.getStock_p();
            String url =Statics.BASE_URL+"/addreclamationJSON/new?objet="+t.getObjet()+"&description="+t.getDescription(); 
    ...
    public ArrayList<Reclamation> getAll() {
        ...
        cr = new ConnectionRequest();   
        cr.setUrl(Statics.BASE_URL + "/Allreclamation");
    ...
    public boolean modifier(Reclamation reclamation) {       
        String url = Statics.BASE_URL +"/updatereclamationJSON"+"/"+(int)reclamation.getId()+"?objet="+reclamation.getObjet()+"&description="+reclamation.getDescription();
